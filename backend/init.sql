...
-- Testing, add more user
INSERT INTO users (id, name, age, email, phone) VALUES
    (14, 'Jackson Braxton', 25, 'angela.doe@example.com', '123-456-7890'),
    (15, 'Kellie Porch', 30, 'kellie.smith@example.com', '098-765-4321'),
    (16, 'Angela Schmidt', 35, 'angela.johnson@example.com', '555-123-4567'),
    (17, 'Jessica Rodriguez', 35, 'JRod@example.com', '555-123-4567')
ON CONFLICT (id) DO NOTHING;

-- Testing, add more posts
INSERT INTO posts (id, user_id, title, content, created_at, updated_at) VALUES
    -- Posts by John Doe (user_id: 1)
    (14, 14, 'Getting Started with Rust', 'Nunc quis felis nec justo facilisis volutpat non sit amet lorem. Aliquam hendrerit scelerisque lacinia. Phasellus magna magna, sodales quis egestas eget, convallis et nisl. Praesent quis nisl a metus finibus ullamcorper quis id dui. Integer nec sapien mattis, dictum ex ut, efficitur orci. Nam laoreet ligula pharetra leo varius, ut porta tortor feugiat. Nullam facilisis magna maximus, ornare erat non, elementum leo. Etiam porta, nulla a ornare rutrum, turpis dolor mollis ligula, eu pretium lectus dui ac mi. Praesent gravida maximus nulla, nec mollis nisi pellentesque non. Nam luctus purus nec nunc ullamcorper, sed consectetur sapien aliquam. Morbi consectetur, mauris ac vehicula blandit, urna dui porttitor nulla, vitae ultrices enim magna nec quam. Suspendisse ut porta odio, id sodales tellus. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Mauris posuere mattis est, ac ullamcorper libero venenatis non.' , '2025-01-01 10:00:00', '2025-01-01 10:00:00'),
    (15, 14, 'Understanding Ownership', 'Nunc quis felis nec justo facilisis volutpat non sit amet lorem. Aliquam hendrerit scelerisque lacinia. Phasellus magna magna, sodales quis egestas eget, convallis et nisl. Praesent quis nisl a metus finibus ullamcorper quis id dui. Integer nec sapien mattis, dictum ex ut, efficitur orci. Nam laoreet ligula pharetra leo varius, ut porta tortor feugiat. Nullam facilisis magna maximus, ornare erat non, elementum leo. Etiam porta, nulla a ornare rutrum, turpis dolor mollis ligula, eu pretium lectus dui ac mi.', '2025-01-02 14:30:00', '2025-01-02 14:30:00'),
    (16, 14, 'Building Web APIs', 'Praesent gravida maximus nulla, nec mollis nisi pellentesque non. Nam luctus purus nec nunc ullamcorper, sed consectetur sapien aliquam. Morbi consectetur, mauris ac vehicula blandit, urna dui porttitor nulla, vitae ultrices enim magna nec quam. Suspendisse ut porta odio, id sodales tellus. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Mauris posuere mattis est, ac ullamcorper libero venenatis non', '2025-01-03 09:15:00', '2025-01-03 09:15:00'),

    -- Posts by Jane Smith (user_id: 2)
    (17, 15, 'GraphQL vs REST', 'Maecenas quis mollis dolor. Aenean dolor risus, malesuada nec fringilla nec, varius sit amet eros. Ut justo purus, eleifend vel vestibulum vel, molestie nec ipsum. Fusce luctus libero eu semper sodales.', '2025-01-01 16:20:00', '2025-01-01 16:20:00'),
    (18, 15, 'Database Design Patterns', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus cursus ac nunc id feugiat. Morbi pellentesque nisi eget orci posuere, vitae congue purus venenatis. Vivamus varius nulla eu nisl efficitur, posuere lobortis velit scelerisque. Aliquam erat volutpat. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.', '2025-01-02 11:45:00', '2025-01-02 11:45:00'),
    (19, 15, 'Frontend State Management', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus cursus ac nunc id feugiat. Morbi pellentesque nisi eget orci posuere, vitae congue purus venenatis. Vivamus varius nulla eu nisl efficitur, posuere lobortis velit scelerisque. Aliquam erat volutpat. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.', '2025-01-04 13:10:00', '2025-01-04 13:10:00'),

    -- Posts by Bob Johnson (user_id: 4)
    (20, 16, 'Docker Containerization', 'Praesent gravida maximus nulla, nec mollis nisi pellentesque non. Nam luctus purus nec nunc ullamcorper, sed consectetur sapien aliquam. Morbi consectetur, mauris ac vehicula blandit, urna dui porttitor nulla, vitae ultrices enim magna nec quam. Suspendisse ut porta odio, id sodales tellus. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Mauris posuere mattis est, ac ullamcorper libero venenatis non', '2025-01-01 08:30:00', '2025-01-01 08:30:00'),
    (21, 16, 'Kubernetes Deployment', 'Vivamus fermentum quam erat. Phasellus maximus, ex sed congue vehicula, arcu est elementum tortor, vel viverra dui felis et mi.',  '2025-01-03 15:45:00', '2025-01-03 15:45:00'),
    (22, 16, 'CI/CD Best Practices', 'Donec viverra malesuada dolor, sed auctor quam mattis quis. Proin vestibulum vel augue ut porttitor. Etiam semper quam et fringilla egestas', '2025-01-05 10:20:00', '2025-01-05 10:20:00')
ON CONFLICT (id) DO NOTHING;